...
public class AdminController {
    ...
    /**
     * Effectue une suppression logique d'un annotateur.
     *
     * @param id ID de l'annotateur à supprimer
     * @return ResponseEntity avec le statut de l'opération
     *
     * Test : Envoyer une requête DELETE à /api/admin/annotateurs/{id} et vérifier :
     * - La suppression logique réussie
  ...
  /*    @DeleteMapping("/annotateurs/{id}")
    ...
    @SecurityRequirement(name = "bearerAuth")
    @io.swagger.v3.oas.annotations.Operation(
        summary = "Supprimer un annotateur", 
        description = "Effectue une suppression logique d'un annotateur (Requiert un rôle ADMIN)")
    @io.swagger.v3.oas.annotations.responses.ApiResponses(value = {
